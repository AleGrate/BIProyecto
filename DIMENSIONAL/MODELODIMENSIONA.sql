...
DROP SCHEMA IF EXISTS SEGURO_G27321522 CASCADE;

CREATE SCHEMA SEGURO_G27321522;
--DIMENSIONES
CREATE TABLE SEGURO_G27321522.DIM_TIEMPO(
...
CREATE TABLE SEGURO_G27321522.DIM_PRODUCTO(
...
CREATE TABLE SEGURO_G27321522.DIM_CLIENTE(
...
CREATE TABLE SEGURO_G27321522.DIM_EVALUACION_SERVICIO(
...
CREATE TABLE SEGURO_G27321522.DIM_CONTRATO(
...
CREATE TABLE SEGURO_G27321522.DIM_ESTADO_CONTRATO(
...
CREATE TABLE SEGURO_G27321522.DIM_SINIESTRO(
...
CREATE TABLE SEGURO_G27321522.DIM_SUCURSAL(
...
CREATE TABLE SEGURO_G27321522.FACT_METAS(
    ...
    CONSTRAINT FK_DIM_FECHA_INICIO_META FOREIGN KEY (SK_DIM_FECHA_INICIO_META) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_FECHA_FIN_META FOREIGN KEY (SK_DIM_FECHA_FIN_META) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_PRODUCTO FOREIGN KEY (SK_DIM_PRODUCTO) REFERENCES SEGURO_G27321522.DIM_PRODUCTO (SK_DIM_PRODUCTO)
);

CREATE TABLE SEGURO_G27321522.FACT_EVALUACION_SERVICIO(
    ...
    CONSTRAINT FK_DIM_FECHA_RECOMIENDA FOREIGN KEY (SK_DIM_FECHA_RECOMIENDA) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_CLIENTE FOREIGN KEY (SK_DIM_CLIENTE) REFERENCES SEGURO_G27321522.DIM_CLIENTE (SK_DIM_CLIENTE),
    CONSTRAINT FK_DIM_PRODUCTO FOREIGN KEY (SK_DIM_PRODUCTO) REFERENCES SEGURO_G27321522.DIM_PRODUCTO (SK_DIM_PRODUCTO),
    CONSTRAINT FK_DIM_EVALUACION_SERVICIO FOREIGN KEY (SK_DIM_EVALUACION_SERVICIO) REFERENCES SEGURO_G27321522.DIM_EVALUACION_SERVICIO(SK_DIM_EVALUACION_SERVICIO)
);

CREATE TABLE SEGURO_G27321522.FACT_REGISTRO_CONTRATO(
    ...
    CONSTRAINT FK_DIM_TIEMPO_FECHA_INICIO FOREIGN KEY (SK_DIM_TIEMPO_FECHA_INICIO) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_TIEMPO_FECHA_FIN FOREIGN KEY (SK_DIM_TIEMPO_FECHA_FIN) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_CLIENTE FOREIGN KEY (SK_DIM_CLIENTE) REFERENCES SEGURO_G27321522.DIM_CLIENTE (SK_DIM_CLIENTE),
    CONSTRAINT FK_DIM_PRODUCTO FOREIGN KEY (SK_DIM_PRODUCTO) REFERENCES SEGURO_G27321522.DIM_PRODUCTO (SK_DIM_PRODUCTO),
    CONSTRAINT FK_DIM_ESTADO_CONTRATO FOREIGN KEY (SK_DIM_ESTADO_CONTRATO) REFERENCES SEGURO_G27321522.DIM_ESTADO_CONTRATO (SK_DIM_ESTADO_CONTRATO)
);

CREATE TABLE SEGURO_G27321522.FACT_REGISTRO_SINIESTRO(
    ...
    CONSTRAINT FK_DIM_FECHA_SINIESTRO FOREIGN KEY (SK_DIM_FECHA_SINIESTRO) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_FECHA_RESPUESTA FOREIGN KEY (SK_DIM_FECHA_RESPUESTA) REFERENCES SEGURO_G27321522.DIM_TIEMPO (SK_DIM_TIEMPO),
    CONSTRAINT FK_DIM_CLIENTE FOREIGN KEY (SK_DIM_CLIENTE) REFERENCES SEGURO_G27321522.DIM_CLIENTE (SK_DIM_CLIENTE),
    CONSTRAINT FK_DIM_SUCURSAL FOREIGN KEY (SK_DIM_SUCURSAL) REFERENCES SEGURO_G27321522.DIM_SUCURSAL (SK_DIM_SUCURSAL),
    CONSTRAINT FK_DIM_CONTRATO FOREIGN KEY (SK_DIM_CONTRATO) REFERENCES SEGURO_G27321522.DIM_CONTRATO (SK_DIM_CONTRATO),
    CONSTRAINT FK_DIM_PRODUCTO FOREIGN KEY (SK_DIM_PRODUCTO) REFERENCES SEGURO_G27321522.DIM_PRODUCTO (SK_DIM_PRODUCTO),
    CONSTRAINT FK_DIM_SINIESTRO FOREIGN KEY (SK_DIM_SINIESTRO) REFERENCES SEGURO_G27321522.DIM_SINIESTRO (SK_DIM_SINIESTRO)
);